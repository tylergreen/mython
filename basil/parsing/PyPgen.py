...
$Id: PyPgen.py 10195 2005-03-31 14:20:23Z jriehl $
"""
# ______________________________________________________________________
# Module imports
    ...
    def translateLabels (self, grammar, additional_tokens = None):
        ...
        for labelIndex in range(0, len(labelList)):
            ...
            if type == token.NAME:
                ...
                elif self.operatorMap.has_key(sname):
...
class PyPgenParser (object):
    ...
    """
    # ____________________________________________________________
    def __init__ (self, grammarObj, tokenizerFactory = None):
        """PyPgenParser.__init__
        Constructor; accepts a DFA tuple (current documented in
        basil.lang.python.DFAParser.__doc__).
        """
